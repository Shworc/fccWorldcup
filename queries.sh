...
echo "$($PSQL "SELECT name FROM teams INNER JOIN games ON teams.team_id = games.winner_id OR teams.team_id = games.opponent_id WHERE games.year=2014 AND round='Eighth-Final' ORDER BY name ASC;")"
